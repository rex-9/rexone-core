...
| Media          | Provider-neutral storage and serialized per-asset image/video/audio optimization, SVG conversion, thumbnails, and SRT subtitles | [Storage & assets](docs/FOUNDATION.md#storage-and-assets)                             |
