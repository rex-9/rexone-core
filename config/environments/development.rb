...
Rails.application.configure do
  ...
  # Allow Action Cable access from any origin (mobile / web emulator)
  ...
  # no more debug logs and SQL queries
  config.log_level = :info

  # Allow requests from localhost and other local addresses
  config.hosts.clear # Allow all hosts (useful for development)
