...
class Payment::SubscriptionSerializer < ApplicationSerializer
  attributes :id, :stripe_subscription_id, :stripe_customer_id,
             :status, :cycle, :payment_method_id, :payment_method_type,
             :current_period_start, :current_period_end, :started_at, :ended_at, :canceled_at,
