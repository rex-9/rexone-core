  ...
  config.openapi_specs = {
    'v1/swagger.yaml' => {
      ...
      tags: [
        ...
        { name: 'Admin / Payment Products', description: 'Admin product management.' },
        { name: 'Admin / Feedbacks', description: 'Admin feedback management and triage.' },
        { name: 'Admin / Chat', description: 'Admin chat moderation.' },
        { name: 'Admin / Analytics', description: 'Admin business and operations analytics overview.' },
